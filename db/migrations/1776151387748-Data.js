module.exports = class Data1776151387748 {
    name = 'Data1776151387748'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "protocol_daily_stat_detail" ("id" character varying NOT NULL, "date" text NOT NULL, "product_id" text NOT NULL, "product" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "rate_usd" numeric NOT NULL, "supply" numeric NOT NULL, "earning_tvl" numeric NOT NULL, "tvl" numeric NOT NULL, "yield" numeric NOT NULL, "revenue" numeric NOT NULL, "apy" numeric NOT NULL, "inherited_tvl" numeric NOT NULL, "inherited_yield" numeric NOT NULL, "inherited_revenue" numeric NOT NULL, "bridged_tvl" numeric NOT NULL, CONSTRAINT "PK_279e9e0ad3c5c1b9f34fd93684a" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_25e652f34770b8661d5ea7139e" ON "protocol_daily_stat_detail" ("date") `)
        await db.query(`CREATE INDEX "IDX_cd5f45f9f4fd67f954d04058a8" ON "protocol_daily_stat_detail" ("product_id") `)
        ...
        await db.query(`CREATE TABLE "protocol_daily_revenue" ("id" character varying NOT NULL, "date" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "total_eth" numeric NOT NULL, "total_usd" numeric NOT NULL, "avg7_eth" numeric NOT NULL, "avg14_eth" numeric NOT NULL, "avg30_eth" numeric NOT NULL, "avg7_usd" numeric NOT NULL, "avg14_usd" numeric NOT NULL, "avg30_usd" numeric NOT NULL, "split" jsonb NOT NULL, CONSTRAINT "PK_3cb6b6f1a1dfdb0cb651d43e9d5" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_f9e2b0324da3c963ecc0e1a3ec" ON "protocol_daily_revenue" ("date") `)
        await db.query(`CREATE INDEX "IDX_6a74f269c03d92982a586887ab" ON "protocol_daily_revenue" ("timestamp") `)
        await db.query(`CREATE TABLE "protocol_daily_tvl" ("id" character varying NOT NULL, "date" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "total_eth" numeric NOT NULL, "total_usd" numeric NOT NULL, "avg7_eth" numeric NOT NULL, "avg14_eth" numeric NOT NULL, "avg30_eth" numeric NOT NULL, "avg7_usd" numeric NOT NULL, "avg14_usd" numeric NOT NULL, "avg30_usd" numeric NOT NULL, "split" jsonb NOT NULL, CONSTRAINT "PK_7bf7f3c364c12480dd94d5d3716" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_4ad04e00a34190af97110cd8d4" ON "protocol_daily_tvl" ("date") `)
        await db.query(`CREATE INDEX "IDX_6b64684855db20a00ff616c0e0" ON "protocol_daily_tvl" ("timestamp") `)
        await db.query(`CREATE TABLE "protocol_daily_token_supply" ("id" character varying NOT NULL, "date" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "total_eth" numeric NOT NULL, "total_usd" numeric NOT NULL, "avg7_eth" numeric NOT NULL, "avg14_eth" numeric NOT NULL, "avg30_eth" numeric NOT NULL, "avg7_usd" numeric NOT NULL, "avg14_usd" numeric NOT NULL, "avg30_usd" numeric NOT NULL, "split" jsonb NOT NULL, CONSTRAINT "PK_300c07c81bddcca5bec5fe87f6a" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_d0579195fc2927256a974f66d0" ON "protocol_daily_token_supply" ("date") `)
        await db.query(`CREATE INDEX "IDX_04f5b40a865fd8bdc977157d45" ON "protocol_daily_token_supply" ("timestamp") `)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_cd5f45f9f4fd67f954d04058a8"`)
        ...
        await db.query(`DROP TABLE "protocol_daily_revenue"`)
        await db.query(`DROP INDEX "public"."IDX_f9e2b0324da3c963ecc0e1a3ec"`)
        await db.query(`DROP INDEX "public"."IDX_6a74f269c03d92982a586887ab"`)
        await db.query(`DROP TABLE "protocol_daily_tvl"`)
        await db.query(`DROP INDEX "public"."IDX_4ad04e00a34190af97110cd8d4"`)
        await db.query(`DROP INDEX "public"."IDX_6b64684855db20a00ff616c0e0"`)
        await db.query(`DROP TABLE "protocol_daily_token_supply"`)
        await db.query(`DROP INDEX "public"."IDX_d0579195fc2927256a974f66d0"`)
        await db.query(`DROP INDEX "public"."IDX_04f5b40a865fd8bdc977157d45"`)
