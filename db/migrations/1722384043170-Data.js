module.exports = class Data1722384043170 {
    name = 'Data1722384043170'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "aero_voter_distribute_reward" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "address" text NOT NULL, "sender" text NOT NULL, "gauge" text NOT NULL, "amount" numeric NOT NULL, CONSTRAINT "PK_6acf9a71278c9263e4430182ac9" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_25d61bbb310eccd73583c0b48d" ON "aero_voter_distribute_reward" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_2393bee84d7b5e332e49483709" ON "aero_voter_distribute_reward" ("block_number") `)
        await db.query(`CREATE INDEX "IDX_71b8bd44535e56fa16f25cd78b" ON "aero_voter_distribute_reward" ("timestamp") `)
        await db.query(`CREATE INDEX "IDX_2b5d28cfb6240f469254c6f7a9" ON "aero_voter_distribute_reward" ("address") `)
        await db.query(`CREATE INDEX "IDX_e112806d150ce86511398cebb6" ON "aero_voter_distribute_reward" ("sender") `)
        await db.query(`CREATE INDEX "IDX_6f6b164fc182d066fd06656e57" ON "aero_voter_distribute_reward" ("gauge") `)
        ...
        await db.query(`CREATE TABLE "aero_voter_gauge_killed" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "address" text NOT NULL, "gauge" text NOT NULL, CONSTRAINT "PK_13bef5877aadaf1a321787a14e1" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_a8dc4a00eb7d26c9d1ba5b2638" ON "aero_voter_gauge_killed" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_561e315134862322ad152bffdb" ON "aero_voter_gauge_killed" ("block_number") `)
        await db.query(`CREATE INDEX "IDX_30d7379b6dc63d68667daa0057" ON "aero_voter_gauge_killed" ("timestamp") `)
        await db.query(`CREATE INDEX "IDX_4fb77921b11989b48098b1feee" ON "aero_voter_gauge_killed" ("address") `)
        await db.query(`CREATE INDEX "IDX_8d5518de480097e6d38fa422ae" ON "aero_voter_gauge_killed" ("gauge") `)
        await db.query(`CREATE TABLE "aero_voter_gauge_revived" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "address" text NOT NULL, "gauge" text NOT NULL, CONSTRAINT "PK_43f2fc88da338a1487709791d61" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_229ee4a5181fc4df3a05012d19" ON "aero_voter_gauge_revived" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_726ba6191a1850f943b652ee8b" ON "aero_voter_gauge_revived" ("block_number") `)
        await db.query(`CREATE INDEX "IDX_938c0678292a0cbb853e1b2d4f" ON "aero_voter_gauge_revived" ("timestamp") `)
        await db.query(`CREATE INDEX "IDX_b7f7bd5cfbba20c449112ad840" ON "aero_voter_gauge_revived" ("address") `)
        await db.query(`CREATE INDEX "IDX_724cf643825793e532874178b7" ON "aero_voter_gauge_revived" ("gauge") `)
        await db.query(`CREATE TABLE "aero_voter_notify_reward" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "address" text NOT NULL, "sender" text NOT NULL, "reward" text NOT NULL, "amount" numeric NOT NULL, CONSTRAINT "PK_689118e7d9009307d1f7523b0fb" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_061dac07aae588f6883759e457" ON "aero_voter_notify_reward" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_50d9310996811cbf1ec34128f0" ON "aero_voter_notify_reward" ("block_number") `)
        await db.query(`CREATE INDEX "IDX_e57e6ab5951b5cba0fdf1d9f41" ON "aero_voter_notify_reward" ("timestamp") `)
        await db.query(`CREATE INDEX "IDX_22d9a1f1da3677e0179a6ec8c2" ON "aero_voter_notify_reward" ("address") `)
        await db.query(`CREATE INDEX "IDX_085329d5b9c696e56e8b70c736" ON "aero_voter_notify_reward" ("sender") `)
        await db.query(`CREATE INDEX "IDX_ed0374e3b55a52ddb2ee9cc45c" ON "aero_voter_notify_reward" ("reward") `)
        ...
        await db.query(`CREATE TABLE "aero_voter_whitelist_nft" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "address" text NOT NULL, "whitelister" text NOT NULL, "token_id" numeric NOT NULL, "bool" boolean NOT NULL, CONSTRAINT "PK_d9d598c9f5a486b486b27577fbe" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_b265107375dc77ac0ecce95c26" ON "aero_voter_whitelist_nft" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_adb757645fc5bf426e80cd1c77" ON "aero_voter_whitelist_nft" ("block_number") `)
        await db.query(`CREATE INDEX "IDX_182e51cc57e073161ef71520d4" ON "aero_voter_whitelist_nft" ("timestamp") `)
        await db.query(`CREATE INDEX "IDX_03c8ce3e0a7300ed723233b0fb" ON "aero_voter_whitelist_nft" ("address") `)
        await db.query(`CREATE INDEX "IDX_11c1ec2c6ffa2c9bd1f9adbdbc" ON "aero_voter_whitelist_nft" ("whitelister") `)
        await db.query(`CREATE INDEX "IDX_c99ab1b9faa8e628cb6acea499" ON "aero_voter_whitelist_nft" ("token_id") `)
        await db.query(`CREATE INDEX "IDX_052c0ce5b639f9e72ddaa148d1" ON "aero_voter_whitelist_nft" ("bool") `)
        await db.query(`CREATE TABLE "aero_voter_whitelist_token" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "address" text NOT NULL, "whitelister" text NOT NULL, "token" text NOT NULL, "bool" boolean NOT NULL, CONSTRAINT "PK_5bc3fbd688fd8d7ee97462af4a9" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_c38f9a176acb1aee55bbff9d0e" ON "aero_voter_whitelist_token" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_ca1f1fc013021a399fe981a048" ON "aero_voter_whitelist_token" ("block_number") `)
        await db.query(`CREATE INDEX "IDX_b43bf32aabdf1931309578da9f" ON "aero_voter_whitelist_token" ("timestamp") `)
        await db.query(`CREATE INDEX "IDX_1458bd9de0df4077184ed96c5f" ON "aero_voter_whitelist_token" ("address") `)
        await db.query(`CREATE INDEX "IDX_a0ae6dc6ce438751300bfabbd9" ON "aero_voter_whitelist_token" ("whitelister") `)
        await db.query(`CREATE INDEX "IDX_ae98ce5fd25706ba8e7e5ccabd" ON "aero_voter_whitelist_token" ("token") `)
        await db.query(`CREATE INDEX "IDX_d149c3e3dfc75dd9a5f62a1751" ON "aero_voter_whitelist_token" ("bool") `)
    ...
    async down(db) {
        ...
        await db.query(`DROP TABLE "aero_voter_distribute_reward"`)
        await db.query(`DROP INDEX "public"."IDX_25d61bbb310eccd73583c0b48d"`)
        await db.query(`DROP INDEX "public"."IDX_2393bee84d7b5e332e49483709"`)
        await db.query(`DROP INDEX "public"."IDX_71b8bd44535e56fa16f25cd78b"`)
        await db.query(`DROP INDEX "public"."IDX_2b5d28cfb6240f469254c6f7a9"`)
        await db.query(`DROP INDEX "public"."IDX_e112806d150ce86511398cebb6"`)
        await db.query(`DROP INDEX "public"."IDX_6f6b164fc182d066fd06656e57"`)
        ...
        await db.query(`DROP TABLE "aero_voter_gauge_killed"`)
        await db.query(`DROP INDEX "public"."IDX_a8dc4a00eb7d26c9d1ba5b2638"`)
        await db.query(`DROP INDEX "public"."IDX_561e315134862322ad152bffdb"`)
        await db.query(`DROP INDEX "public"."IDX_30d7379b6dc63d68667daa0057"`)
        await db.query(`DROP INDEX "public"."IDX_4fb77921b11989b48098b1feee"`)
        await db.query(`DROP INDEX "public"."IDX_8d5518de480097e6d38fa422ae"`)
        await db.query(`DROP TABLE "aero_voter_gauge_revived"`)
        await db.query(`DROP INDEX "public"."IDX_229ee4a5181fc4df3a05012d19"`)
        await db.query(`DROP INDEX "public"."IDX_726ba6191a1850f943b652ee8b"`)
        await db.query(`DROP INDEX "public"."IDX_938c0678292a0cbb853e1b2d4f"`)
        await db.query(`DROP INDEX "public"."IDX_b7f7bd5cfbba20c449112ad840"`)
        await db.query(`DROP INDEX "public"."IDX_724cf643825793e532874178b7"`)
        await db.query(`DROP TABLE "aero_voter_notify_reward"`)
        await db.query(`DROP INDEX "public"."IDX_061dac07aae588f6883759e457"`)
        await db.query(`DROP INDEX "public"."IDX_50d9310996811cbf1ec34128f0"`)
        await db.query(`DROP INDEX "public"."IDX_e57e6ab5951b5cba0fdf1d9f41"`)
        await db.query(`DROP INDEX "public"."IDX_22d9a1f1da3677e0179a6ec8c2"`)
        await db.query(`DROP INDEX "public"."IDX_085329d5b9c696e56e8b70c736"`)
        await db.query(`DROP INDEX "public"."IDX_ed0374e3b55a52ddb2ee9cc45c"`)
        ...
        await db.query(`DROP TABLE "aero_voter_whitelist_nft"`)
        await db.query(`DROP INDEX "public"."IDX_b265107375dc77ac0ecce95c26"`)
        await db.query(`DROP INDEX "public"."IDX_adb757645fc5bf426e80cd1c77"`)
        await db.query(`DROP INDEX "public"."IDX_182e51cc57e073161ef71520d4"`)
        await db.query(`DROP INDEX "public"."IDX_03c8ce3e0a7300ed723233b0fb"`)
        await db.query(`DROP INDEX "public"."IDX_11c1ec2c6ffa2c9bd1f9adbdbc"`)
        await db.query(`DROP INDEX "public"."IDX_c99ab1b9faa8e628cb6acea499"`)
        await db.query(`DROP INDEX "public"."IDX_052c0ce5b639f9e72ddaa148d1"`)
        await db.query(`DROP TABLE "aero_voter_whitelist_token"`)
        await db.query(`DROP INDEX "public"."IDX_c38f9a176acb1aee55bbff9d0e"`)
        await db.query(`DROP INDEX "public"."IDX_ca1f1fc013021a399fe981a048"`)
        await db.query(`DROP INDEX "public"."IDX_b43bf32aabdf1931309578da9f"`)
        await db.query(`DROP INDEX "public"."IDX_1458bd9de0df4077184ed96c5f"`)
        await db.query(`DROP INDEX "public"."IDX_a0ae6dc6ce438751300bfabbd9"`)
        await db.query(`DROP INDEX "public"."IDX_ae98ce5fd25706ba8e7e5ccabd"`)
        await db.query(`DROP INDEX "public"."IDX_d149c3e3dfc75dd9a5f62a1751"`)
