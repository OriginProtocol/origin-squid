module.exports = class Data1784875467052 {
    name = 'Data1784875467052'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "protocol_daily_stat_detail" ("id" character varying NOT NULL, "date" text NOT NULL, "product" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "rate_usd" numeric NOT NULL, "rate_eth" numeric NOT NULL, "supply" numeric NOT NULL, "earning_tvl" numeric NOT NULL, "tvl" numeric NOT NULL, "yield" numeric NOT NULL, "revenue" numeric NOT NULL, "apy" numeric NOT NULL, "inherited_tvl" numeric NOT NULL, "inherited_yield" numeric NOT NULL, "inherited_revenue" numeric NOT NULL, "bridged_tvl" numeric NOT NULL, CONSTRAINT "PK_279e9e0ad3c5c1b9f34fd93684a" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "o_token_address_yield" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "otoken" text NOT NULL, "address" text NOT NULL, "date" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "balance" numeric NOT NULL, "cost_basis" numeric NOT NULL, "yield" numeric NOT NULL, "cumulative_yield" numeric NOT NULL, "roi" numeric NOT NULL, CONSTRAINT "PK_3a51ade95f29c46dce5ec03561b" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_18f2fa03b3cf7a2a1ad2abc50a" ON "o_token_address_yield" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_a7ca43e7479fe175c4fdef6a7e" ON "o_token_address_yield" ("otoken") `)
        await db.query(`CREATE INDEX "IDX_a8c0d467d13b8dd5ed32977811" ON "o_token_address_yield" ("address") `)
        await db.query(`CREATE INDEX "IDX_c06dd25cbfc9dcb92655966a32" ON "o_token_address_yield" ("date") `)
        await db.query(`CREATE INDEX "IDX_ca785f8a0107edadfbe8da881d" ON "o_token_address_yield" ("block_number") `)
        ...
        await db.query(`CREATE TABLE "o_token_daily_stat" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "otoken" text NOT NULL, "date" text NOT NULL, "apr" numeric NOT NULL, "apy" numeric NOT NULL, "apy7" numeric NOT NULL, "apy14" numeric NOT NULL, "apy30" numeric NOT NULL, "peg" numeric NOT NULL, "rate_usd" numeric NOT NULL, "rate_eth" numeric NOT NULL, "rate_native" numeric NOT NULL, "total_supply" numeric NOT NULL, "rebasing_supply" numeric NOT NULL, "non_rebasing_supply" numeric NOT NULL, "wrapped_supply" numeric NOT NULL, "rate_wrapped" numeric NOT NULL, "amo_supply" numeric, "dripper_weth" numeric NOT NULL, "yield" numeric NOT NULL, "fees" numeric NOT NULL, "cumulative_yield" numeric NOT NULL, "cumulative_fees" numeric NOT NULL, "market_cap_usd" numeric NOT NULL, "accounts_over_threshold" integer NOT NULL, CONSTRAINT "PK_eeabae008c52207e32e2171176d" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "arm" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "address" text NOT NULL, "name" text NOT NULL, "symbol" text NOT NULL, "decimals" integer NOT NULL, "token0" text NOT NULL, "token1" text NOT NULL, "assets" text array NOT NULL, "asset_symbols" text array NOT NULL, "asset_decimals" integer array NOT NULL, "asset_pegged" boolean array NOT NULL, "asset_adapters" text array NOT NULL, "upgrade_block" integer, CONSTRAINT "PK_711e2a749a8c4baeccf8365290c" PRIMARY KEY ("id"))`)
        await db.query(`CREATE TABLE "arm_state" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "address" text NOT NULL, "assets0" numeric NOT NULL, "assets1" numeric NOT NULL, "outstanding_assets1" numeric NOT NULL, "market_assets" numeric NOT NULL, "fees_accrued" numeric NOT NULL, "total_assets" numeric NOT NULL, "total_assets_cap" numeric NOT NULL, "total_supply" numeric NOT NULL, "assets_per_share" numeric NOT NULL, "total_deposits" numeric NOT NULL, "total_withdrawals" numeric NOT NULL, "total_withdrawals_claimed" numeric NOT NULL, "total_yield" numeric NOT NULL, "total_fees" numeric NOT NULL, "claimable" numeric NOT NULL, "asset_balances" text array NOT NULL, "asset_totals" text array NOT NULL, "outstanding_assets" text array NOT NULL, "market_shares" numeric NOT NULL, "market_price_per_share" numeric NOT NULL, "active_market" text NOT NULL, CONSTRAINT "PK_e58fff61dd95dfeac112204c378" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "arm_daily_stat" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "date" text NOT NULL, "address" text NOT NULL, "assets0" numeric NOT NULL, "assets1" numeric NOT NULL, "outstanding_assets1" numeric NOT NULL, "market_assets" numeric NOT NULL, "fees_accrued" numeric NOT NULL, "total_assets" numeric NOT NULL, "total_assets_cap" numeric NOT NULL, "total_supply" numeric NOT NULL, "assets_per_share" numeric NOT NULL, "total_deposits" numeric NOT NULL, "total_withdrawals" numeric NOT NULL, "total_withdrawals_claimed" numeric NOT NULL, "apr" numeric NOT NULL, "apy" numeric NOT NULL, "incentive_yield" numeric NOT NULL, "incentive_apr" numeric NOT NULL, "incentive_apy" numeric NOT NULL, "yield" numeric NOT NULL, "fees" numeric NOT NULL, "cumulative_yield" numeric NOT NULL, "cumulative_fees" numeric NOT NULL, "rate_usd" numeric NOT NULL, "rate_eth" numeric NOT NULL, "rate_native" numeric NOT NULL, "rate_asset1" numeric NOT NULL, "assets" text array NOT NULL, "asset_symbols" text array NOT NULL, "asset_decimals" integer array NOT NULL, "asset_balances" text array NOT NULL, "asset_totals" text array NOT NULL, "asset_rates" text array NOT NULL, "asset_rates_liquidity" text array NOT NULL, "asset_rates_usd" text array NOT NULL, "asset_rates_eth" text array NOT NULL, "asset_rates_native" text array NOT NULL, "outstanding_assets" text array NOT NULL, "market_shares" numeric NOT NULL, "market_price_per_share" numeric NOT NULL, "active_market" text NOT NULL, CONSTRAINT "PK_c780cd8a4ec31366f7173a30fb1" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "arm_swap" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "tx_hash" text NOT NULL, "tx_from" text NOT NULL, "tx_to" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "address" text NOT NULL, "from" text NOT NULL, "token_in" text NOT NULL, "token_out" text NOT NULL, "amount_in" numeric NOT NULL, "amount_out" numeric NOT NULL, "rate_in" numeric NOT NULL, "rate_out" numeric NOT NULL, "assets0" numeric NOT NULL, "assets1" numeric NOT NULL, "spread" numeric NOT NULL, CONSTRAINT "PK_e598ac0f753595d846714dec664" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "arm_daily_asset_yield" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "address" text NOT NULL, "asset" text NOT NULL, "asset_symbol" text NOT NULL, "date" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "trading_yield" numeric NOT NULL, "appreciation_yield" numeric NOT NULL, "lending_yield" numeric NOT NULL, "yield" numeric NOT NULL, "swap_volume" numeric NOT NULL, CONSTRAINT "PK_80a264278146f428b50c1f6c630" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_01d4b055b3ae14b55487052d9e" ON "arm_daily_asset_yield" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_2bbce639503e9a6ee1a4fd8e89" ON "arm_daily_asset_yield" ("address") `)
        await db.query(`CREATE INDEX "IDX_fd637c92d3c865986a72d6c27f" ON "arm_daily_asset_yield" ("asset") `)
        await db.query(`CREATE INDEX "IDX_a1b72d191fb08e81eec2aa466e" ON "arm_daily_asset_yield" ("date") `)
        await db.query(`CREATE INDEX "IDX_e651db6e1c3e24f5773742f2fa" ON "arm_daily_asset_yield" ("timestamp") `)
        await db.query(`CREATE INDEX "IDX_e41b0b0cf8c48c804fd1d20ca6" ON "arm_daily_asset_yield" ("block_number") `)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_e41b0b0cf8c48c804fd1d20ca6"`)
        await db.query(`DROP INDEX "public"."IDX_e651db6e1c3e24f5773742f2fa"`)
        await db.query(`DROP INDEX "public"."IDX_a1b72d191fb08e81eec2aa466e"`)
        await db.query(`DROP INDEX "public"."IDX_fd637c92d3c865986a72d6c27f"`)
        await db.query(`DROP INDEX "public"."IDX_2bbce639503e9a6ee1a4fd8e89"`)
        await db.query(`DROP INDEX "public"."IDX_01d4b055b3ae14b55487052d9e"`)
        await db.query(`DROP TABLE "arm_daily_asset_yield"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_ca785f8a0107edadfbe8da881d"`)
        await db.query(`DROP INDEX "public"."IDX_c06dd25cbfc9dcb92655966a32"`)
        await db.query(`DROP INDEX "public"."IDX_a8c0d467d13b8dd5ed32977811"`)
        await db.query(`DROP INDEX "public"."IDX_a7ca43e7479fe175c4fdef6a7e"`)
        await db.query(`DROP INDEX "public"."IDX_18f2fa03b3cf7a2a1ad2abc50a"`)
        await db.query(`DROP TABLE "o_token_address_yield"`)
