module.exports = class Data1716332143675 {
    name = 'Data1716332143675'

    async up(db) {
        await db.query(`CREATE TABLE "exponential_staking" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "address" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "acc_reward_per_share" numeric NOT NULL, "asset_balance" numeric NOT NULL, CONSTRAINT "PK_ec40683ce69d33cf491bd8a5f3c" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_9004da9adf2bb66b8cc9a9ddbd" ON "exponential_staking" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_bf1eab37b83a2261ba42a53b32" ON "exponential_staking" ("address") `)
        await db.query(`CREATE INDEX "IDX_12fcf9c28429a1047732dd028b" ON "exponential_staking" ("timestamp") `)
        await db.query(`CREATE INDEX "IDX_ed1440d963237e211f39c26c43" ON "exponential_staking" ("block_number") `)
        ...
        await db.query(`CREATE INDEX "IDX_d9e01c551c9f1a4d7710242ed8" ON "exponential_staking_lockup" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_9c8d024fea4fe0a45d95c801d5" ON "exponential_staking_lockup" ("address") `)
        await db.query(`CREATE INDEX "IDX_c31d2fe385b684604bfa071229" ON "exponential_staking_lockup" ("account") `)
        await db.query(`CREATE INDEX "IDX_9e8c0b852aeb43e4ca4a44fc70" ON "exponential_staking_lockup" ("lockup_id") `)
        await db.query(`CREATE TABLE "exponential_staking_account" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "address" text NOT NULL, "account" text NOT NULL, "votes" numeric NOT NULL, "balance" numeric NOT NULL, "preview_points" numeric NOT NULL, "preview_rewards" numeric NOT NULL, "preview_withdraw" numeric NOT NULL, CONSTRAINT "PK_b10010a05da6f8fdf0d030c5d82" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_e55574850608a204d5e3068b85" ON "exponential_staking_account" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_f2cf0e2b357e83e3c99c9076cd" ON "exponential_staking_account" ("address") `)
        await db.query(`CREATE INDEX "IDX_aa85510db9e37072506a7c6c02" ON "exponential_staking_account" ("account") `)
        await db.query(`CREATE TABLE "exponential_staking_delegate_changed" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "address" text NOT NULL, "delegator" text NOT NULL, "from_delegate" text NOT NULL, "to_delegate" text NOT NULL, CONSTRAINT "PK_e09bddf9ba0a1f924d668027121" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_9de723df03ba620afd586dbbf2" ON "exponential_staking_delegate_changed" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_2c19bc13f9e9c65b521be853b0" ON "exponential_staking_delegate_changed" ("address") `)
        await db.query(`CREATE INDEX "IDX_83bb461676640a6666f4c34240" ON "exponential_staking_delegate_changed" ("delegator") `)
        await db.query(`CREATE TABLE "exponential_staking_delegate_votes_changed" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "address" text NOT NULL, "delegate" text NOT NULL, "previous_balance" numeric NOT NULL, "new_balance" numeric NOT NULL, CONSTRAINT "PK_3c0770caf6cd7add1f6c5121d17" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_8bb7224130c6f200d3800d81ad" ON "exponential_staking_delegate_votes_changed" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_8a1b69ff53c4fdf5fbe4b1ef8a" ON "exponential_staking_delegate_votes_changed" ("address") `)
        await db.query(`CREATE INDEX "IDX_c61dfffcf23d4988983ceb67e9" ON "exponential_staking_delegate_votes_changed" ("delegate") `)
        await db.query(`CREATE TABLE "exponential_staking_penalty" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "address" text NOT NULL, "account" text NOT NULL, "amount" numeric NOT NULL, CONSTRAINT "PK_6066556e7ac7611aa30852d522c" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_686c1e7635d16ed4974d4fba7e" ON "exponential_staking_penalty" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_e8d2ec04a0cabd68281ffbced0" ON "exponential_staking_penalty" ("address") `)
        await db.query(`CREATE INDEX "IDX_8a204e6d28385b4971177fd73b" ON "exponential_staking_penalty" ("account") `)
        await db.query(`CREATE TABLE "exponential_staking_reward" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "address" text NOT NULL, "account" text NOT NULL, "amount" numeric NOT NULL, CONSTRAINT "PK_506c1ea29e2e93a51a250d5d457" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_c2503d0a7f3c5a4176b80b6ee6" ON "exponential_staking_reward" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_af7a218b05626c5b6b3b6a4702" ON "exponential_staking_reward" ("address") `)
        await db.query(`CREATE INDEX "IDX_b252d19aa52a4683819bdd94b8" ON "exponential_staking_reward" ("account") `)
        await db.query(`CREATE TABLE "exponential_staking_stake" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "address" text NOT NULL, "account" text NOT NULL, "lockup_id" numeric NOT NULL, "amount" numeric NOT NULL, "end" numeric NOT NULL, "points" numeric NOT NULL, CONSTRAINT "PK_6f31743cbb489b127e964f97bb6" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_c6b9bbec61e2fca250ce7d4a32" ON "exponential_staking_stake" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_9e93319f4c9133472807912986" ON "exponential_staking_stake" ("address") `)
        await db.query(`CREATE INDEX "IDX_c38f73385b9aae63c9a8e4cd57" ON "exponential_staking_stake" ("account") `)
        await db.query(`CREATE INDEX "IDX_6aa54b83c2205337175f5a6e17" ON "exponential_staking_stake" ("lockup_id") `)
        await db.query(`CREATE TABLE "exponential_staking_unstake" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "address" text NOT NULL, "account" text NOT NULL, "lockup_id" numeric NOT NULL, "amount" numeric NOT NULL, "end" numeric NOT NULL, "points" numeric NOT NULL, CONSTRAINT "PK_2a537c20d900d4efec853755435" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_3a3fa2fd9ffdd64dca1d5ab3b8" ON "exponential_staking_unstake" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_7cd924c25b352e2288137ca23b" ON "exponential_staking_unstake" ("address") `)
        await db.query(`CREATE INDEX "IDX_f2dff3c4211d5d57eaf627b6c8" ON "exponential_staking_unstake" ("account") `)
        await db.query(`CREATE INDEX "IDX_5eba41d0c2d4d5ff4c5e5c0411" ON "exponential_staking_unstake" ("lockup_id") `)
        await db.query(`CREATE TABLE "governorship_transferred" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "address" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "previous_governor" text NOT NULL, "new_governor" text NOT NULL, CONSTRAINT "PK_a8377859ab1cb2c7179f248e4e2" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_9ab2b5486d85bd8aa36730fc02" ON "governorship_transferred" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_554f6c0e2738e30856bdc4b725" ON "governorship_transferred" ("address") `)
        await db.query(`CREATE INDEX "IDX_d955cfa47fa1ff270a5578ba43" ON "governorship_transferred" ("timestamp") `)
        await db.query(`CREATE INDEX "IDX_9d0eb3c05b7d0585f9d8d9eeb0" ON "governorship_transferred" ("block_number") `)
        await db.query(`CREATE TABLE "pending_governorship_transfer" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "address" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "previous_governor" text NOT NULL, "new_governor" text NOT NULL, CONSTRAINT "PK_68913ab28a55f5a756c70ca31c3" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_92e258fe6b6f9c65cdbe750c65" ON "pending_governorship_transfer" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_0fe23661b80871659e54dda998" ON "pending_governorship_transfer" ("address") `)
        await db.query(`CREATE INDEX "IDX_d17c593674455b0554220cf1b0" ON "pending_governorship_transfer" ("timestamp") `)
        await db.query(`CREATE INDEX "IDX_2b89e9ec7edc194f9f0a914053" ON "pending_governorship_transfer" ("block_number") `)
        await db.query(`CREATE TABLE "reward_collected" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "address" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "amount_collected" numeric NOT NULL, CONSTRAINT "PK_b9219358e897a814168f7d9f805" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_0f6ab10957c09ebed8b2fc25c5" ON "reward_collected" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_f6c2334f64b880139f96db37a5" ON "reward_collected" ("address") `)
        await db.query(`CREATE INDEX "IDX_fd3d30debdb9c5981471747b9b" ON "reward_collected" ("timestamp") `)
        await db.query(`CREATE INDEX "IDX_0ea0eaa90ecddef5213a787419" ON "reward_collected" ("block_number") `)
        await db.query(`CREATE TABLE "rewards_per_second_changed" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "address" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "new_rps" numeric NOT NULL, "old_rps" numeric NOT NULL, CONSTRAINT "PK_716c2975993acabb52c7e4c1bd6" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_b820e1afc853dffd1556e7b2a6" ON "rewards_per_second_changed" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_fdd9f60fc758695e25ae3ef6ca" ON "rewards_per_second_changed" ("address") `)
        await db.query(`CREATE INDEX "IDX_487950908e327e4ccabd36820b" ON "rewards_per_second_changed" ("timestamp") `)
        await db.query(`CREATE INDEX "IDX_da9541b9abd658528a015df4cc" ON "rewards_per_second_changed" ("block_number") `)
        await db.query(`CREATE TABLE "rewards_target_change" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "address" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "target" text NOT NULL, "previous_target" text NOT NULL, CONSTRAINT "PK_99bc1b16e49937a7f1ca2068c58" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_57ca8bf4b751d1de10f44a08d6" ON "rewards_target_change" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_de0fb0e64b2f2012da9e29d277" ON "rewards_target_change" ("address") `)
        await db.query(`CREATE INDEX "IDX_e21598b3cc8c9f85c4af20433c" ON "rewards_target_change" ("timestamp") `)
        await db.query(`CREATE INDEX "IDX_6b94b5ef03dd72ed73f3209642" ON "rewards_target_change" ("block_number") `)
        await db.query(`CREATE TABLE "strategist_updated" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "address" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "strategist_address" text NOT NULL, CONSTRAINT "PK_ed7a217e068cbc1762e9c04e68d" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_3ddb234b6c80ea1d59b2922fe4" ON "strategist_updated" ("chain_id") `)
        await db.query(`CREATE INDEX "IDX_103140942203924024fcb8fbbd" ON "strategist_updated" ("address") `)
        await db.query(`CREATE INDEX "IDX_0d9424ca64d47f409467f3ccc5" ON "strategist_updated" ("timestamp") `)
        await db.query(`CREATE INDEX "IDX_3e6d818b5c76a45fdd1b7ff18c" ON "strategist_updated" ("block_number") `)
    ...
    async down(db) {
        await db.query(`DROP TABLE "exponential_staking"`)
        await db.query(`DROP INDEX "public"."IDX_9004da9adf2bb66b8cc9a9ddbd"`)
        await db.query(`DROP INDEX "public"."IDX_bf1eab37b83a2261ba42a53b32"`)
        await db.query(`DROP INDEX "public"."IDX_12fcf9c28429a1047732dd028b"`)
        await db.query(`DROP INDEX "public"."IDX_ed1440d963237e211f39c26c43"`)
        await db.query(`DROP TABLE "exponential_staking_lockup"`)
        await db.query(`DROP INDEX "public"."IDX_d9e01c551c9f1a4d7710242ed8"`)
        await db.query(`DROP INDEX "public"."IDX_9c8d024fea4fe0a45d95c801d5"`)
        await db.query(`DROP INDEX "public"."IDX_c31d2fe385b684604bfa071229"`)
        await db.query(`DROP INDEX "public"."IDX_9e8c0b852aeb43e4ca4a44fc70"`)
        await db.query(`DROP TABLE "exponential_staking_account"`)
        await db.query(`DROP INDEX "public"."IDX_e55574850608a204d5e3068b85"`)
        await db.query(`DROP INDEX "public"."IDX_f2cf0e2b357e83e3c99c9076cd"`)
        await db.query(`DROP INDEX "public"."IDX_aa85510db9e37072506a7c6c02"`)
        await db.query(`DROP TABLE "exponential_staking_delegate_changed"`)
        await db.query(`DROP INDEX "public"."IDX_9de723df03ba620afd586dbbf2"`)
        await db.query(`DROP INDEX "public"."IDX_2c19bc13f9e9c65b521be853b0"`)
        await db.query(`DROP INDEX "public"."IDX_83bb461676640a6666f4c34240"`)
        await db.query(`DROP TABLE "exponential_staking_delegate_votes_changed"`)
        await db.query(`DROP INDEX "public"."IDX_8bb7224130c6f200d3800d81ad"`)
        await db.query(`DROP INDEX "public"."IDX_8a1b69ff53c4fdf5fbe4b1ef8a"`)
        await db.query(`DROP INDEX "public"."IDX_c61dfffcf23d4988983ceb67e9"`)
        await db.query(`DROP TABLE "exponential_staking_penalty"`)
        await db.query(`DROP INDEX "public"."IDX_686c1e7635d16ed4974d4fba7e"`)
        await db.query(`DROP INDEX "public"."IDX_e8d2ec04a0cabd68281ffbced0"`)
        await db.query(`DROP INDEX "public"."IDX_8a204e6d28385b4971177fd73b"`)
        await db.query(`DROP TABLE "exponential_staking_reward"`)
        await db.query(`DROP INDEX "public"."IDX_c2503d0a7f3c5a4176b80b6ee6"`)
        await db.query(`DROP INDEX "public"."IDX_af7a218b05626c5b6b3b6a4702"`)
        await db.query(`DROP INDEX "public"."IDX_b252d19aa52a4683819bdd94b8"`)
        await db.query(`DROP TABLE "exponential_staking_stake"`)
        await db.query(`DROP INDEX "public"."IDX_c6b9bbec61e2fca250ce7d4a32"`)
        await db.query(`DROP INDEX "public"."IDX_9e93319f4c9133472807912986"`)
        await db.query(`DROP INDEX "public"."IDX_c38f73385b9aae63c9a8e4cd57"`)
        await db.query(`DROP INDEX "public"."IDX_6aa54b83c2205337175f5a6e17"`)
        await db.query(`DROP TABLE "exponential_staking_unstake"`)
        await db.query(`DROP INDEX "public"."IDX_3a3fa2fd9ffdd64dca1d5ab3b8"`)
        await db.query(`DROP INDEX "public"."IDX_7cd924c25b352e2288137ca23b"`)
        await db.query(`DROP INDEX "public"."IDX_f2dff3c4211d5d57eaf627b6c8"`)
        await db.query(`DROP INDEX "public"."IDX_5eba41d0c2d4d5ff4c5e5c0411"`)
        await db.query(`DROP TABLE "governorship_transferred"`)
        await db.query(`DROP INDEX "public"."IDX_9ab2b5486d85bd8aa36730fc02"`)
        await db.query(`DROP INDEX "public"."IDX_554f6c0e2738e30856bdc4b725"`)
        await db.query(`DROP INDEX "public"."IDX_d955cfa47fa1ff270a5578ba43"`)
        await db.query(`DROP INDEX "public"."IDX_9d0eb3c05b7d0585f9d8d9eeb0"`)
        await db.query(`DROP TABLE "pending_governorship_transfer"`)
        await db.query(`DROP INDEX "public"."IDX_92e258fe6b6f9c65cdbe750c65"`)
        await db.query(`DROP INDEX "public"."IDX_0fe23661b80871659e54dda998"`)
        await db.query(`DROP INDEX "public"."IDX_d17c593674455b0554220cf1b0"`)
        await db.query(`DROP INDEX "public"."IDX_2b89e9ec7edc194f9f0a914053"`)
        await db.query(`DROP TABLE "reward_collected"`)
        await db.query(`DROP INDEX "public"."IDX_0f6ab10957c09ebed8b2fc25c5"`)
        await db.query(`DROP INDEX "public"."IDX_f6c2334f64b880139f96db37a5"`)
        await db.query(`DROP INDEX "public"."IDX_fd3d30debdb9c5981471747b9b"`)
        await db.query(`DROP INDEX "public"."IDX_0ea0eaa90ecddef5213a787419"`)
        await db.query(`DROP TABLE "rewards_per_second_changed"`)
        await db.query(`DROP INDEX "public"."IDX_b820e1afc853dffd1556e7b2a6"`)
        await db.query(`DROP INDEX "public"."IDX_fdd9f60fc758695e25ae3ef6ca"`)
        await db.query(`DROP INDEX "public"."IDX_487950908e327e4ccabd36820b"`)
        await db.query(`DROP INDEX "public"."IDX_da9541b9abd658528a015df4cc"`)
        await db.query(`DROP TABLE "rewards_target_change"`)
        await db.query(`DROP INDEX "public"."IDX_57ca8bf4b751d1de10f44a08d6"`)
        await db.query(`DROP INDEX "public"."IDX_de0fb0e64b2f2012da9e29d277"`)
        await db.query(`DROP INDEX "public"."IDX_e21598b3cc8c9f85c4af20433c"`)
        await db.query(`DROP INDEX "public"."IDX_6b94b5ef03dd72ed73f3209642"`)
        await db.query(`DROP TABLE "strategist_updated"`)
        await db.query(`DROP INDEX "public"."IDX_3ddb234b6c80ea1d59b2922fe4"`)
        await db.query(`DROP INDEX "public"."IDX_103140942203924024fcb8fbbd"`)
        await db.query(`DROP INDEX "public"."IDX_0d9424ca64d47f409467f3ccc5"`)
        await db.query(`DROP INDEX "public"."IDX_3e6d818b5c76a45fdd1b7ff18c"`)
