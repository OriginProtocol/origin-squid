module.exports = class Data1717645844084 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "ogn" ("id" character varying NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "circulating" numeric NOT NULL, "staked" numeric NOT NULL, "total" numeric NOT NULL, CONSTRAINT "PK_7a70a9927de8edee1ecaa93948c" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_c23079c2f2a5e62cecdaa4ba3e" ON "ogn" ("timestamp") `)
        await db.query(`CREATE INDEX "IDX_84b34667c285778b066dca4bbe" ON "ogn" ("block_number") `)
        await db.query(`CREATE TABLE "ogn_address" ("id" character varying NOT NULL, "balance" numeric NOT NULL, "staked" numeric NOT NULL, "xogn_balance" numeric NOT NULL, "voting_power" numeric NOT NULL, "last_updated" TIMESTAMP WITH TIME ZONE NOT NULL, "delegatee_id" character varying, CONSTRAINT "PK_dd5bf6942f895beeed52cbe726b" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_8ad97ec59533410a3467822242" ON "ogn_address" ("delegatee_id") `)
        await db.query(`CREATE TABLE "ogn_lockup" ("id" character varying NOT NULL, "lockup_id" text NOT NULL, "amount" numeric NOT NULL, "end" TIMESTAMP WITH TIME ZONE NOT NULL, "xogn" numeric NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "address_id" character varying, CONSTRAINT "PK_cbf31a04e74146c349734d43867" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_38d7bf0eaf6fc6934e199d4791" ON "ogn_lockup" ("lockup_id") `)
        await db.query(`CREATE INDEX "IDX_a38f7bb8e83ffb88f8c7be4676" ON "ogn_lockup" ("address_id") `)
        await db.query(`CREATE TABLE "ogn_lockup_tx_log" ("id" character varying NOT NULL, "hash" text NOT NULL, "event" character varying(8) NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "total_supply" numeric NOT NULL, "ogn_lockup_id" character varying, CONSTRAINT "PK_aec3dc4bd680e7d8fed772f0899" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_f5efab1b224515ed2df14e1ebf" ON "ogn_lockup_tx_log" ("ogn_lockup_id") `)
        ...
        await db.query(`CREATE INDEX "IDX_2d074f6338cb22a33155ab29bf" ON "ogn_proposal" ("proposer_id") `)
        await db.query(`CREATE TABLE "ogn_proposal_tx_log" ("id" character varying NOT NULL, "hash" text NOT NULL, "event" character varying(8) NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "proposal_id" character varying, CONSTRAINT "PK_fff98ddfd36e07523e8d904f9bf" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_d28fb6515ffd9e89012dea5aa1" ON "ogn_proposal_tx_log" ("proposal_id") `)
        await db.query(`CREATE TABLE "ogn_proposal_vote" ("id" character varying NOT NULL, "weight" numeric NOT NULL, "type" character varying(7) NOT NULL, "tx_hash" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "proposal_id" character varying, "voter_id" character varying, CONSTRAINT "PK_80239377cba35bf4169d6595d50" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_a19f392300cd06e787386b28b6" ON "ogn_proposal_vote" ("proposal_id") `)
        await db.query(`CREATE INDEX "IDX_9214b544b868819bae7a431c36" ON "ogn_proposal_vote" ("voter_id") `)
        ...
        await db.query(`ALTER TABLE "ogn_address" ADD CONSTRAINT "FK_8ad97ec59533410a3467822242a" FOREIGN KEY ("delegatee_id") REFERENCES "ogn_address"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "ogn_lockup" ADD CONSTRAINT "FK_a38f7bb8e83ffb88f8c7be46760" FOREIGN KEY ("address_id") REFERENCES "ogn_address"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "ogn_lockup_tx_log" ADD CONSTRAINT "FK_f5efab1b224515ed2df14e1ebfa" FOREIGN KEY ("ogn_lockup_id") REFERENCES "ogn_lockup"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "ogn_proposal" ADD CONSTRAINT "FK_2d074f6338cb22a33155ab29bf2" FOREIGN KEY ("proposer_id") REFERENCES "ogn_address"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "ogn_proposal_tx_log" ADD CONSTRAINT "FK_d28fb6515ffd9e89012dea5aa17" FOREIGN KEY ("proposal_id") REFERENCES "ogn_proposal"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "ogn_proposal_vote" ADD CONSTRAINT "FK_a19f392300cd06e787386b28b69" FOREIGN KEY ("proposal_id") REFERENCES "ogn_proposal"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "ogn_proposal_vote" ADD CONSTRAINT "FK_9214b544b868819bae7a431c369" FOREIGN KEY ("voter_id") REFERENCES "ogn_address"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    async down(db) {
        ...
        await db.query(`DROP TABLE "ogn"`)
        await db.query(`DROP INDEX "public"."IDX_c23079c2f2a5e62cecdaa4ba3e"`)
        await db.query(`DROP INDEX "public"."IDX_84b34667c285778b066dca4bbe"`)
        await db.query(`DROP TABLE "ogn_address"`)
        await db.query(`DROP INDEX "public"."IDX_8ad97ec59533410a3467822242"`)
        await db.query(`DROP TABLE "ogn_lockup"`)
        await db.query(`DROP INDEX "public"."IDX_38d7bf0eaf6fc6934e199d4791"`)
        await db.query(`DROP INDEX "public"."IDX_a38f7bb8e83ffb88f8c7be4676"`)
        await db.query(`DROP TABLE "ogn_lockup_tx_log"`)
        await db.query(`DROP INDEX "public"."IDX_f5efab1b224515ed2df14e1ebf"`)
        await db.query(`DROP TABLE "ogn_proposal"`)
        await db.query(`DROP INDEX "public"."IDX_2d074f6338cb22a33155ab29bf"`)
        await db.query(`DROP TABLE "ogn_proposal_tx_log"`)
        await db.query(`DROP INDEX "public"."IDX_d28fb6515ffd9e89012dea5aa1"`)
        await db.query(`DROP TABLE "ogn_proposal_vote"`)
        await db.query(`DROP INDEX "public"."IDX_a19f392300cd06e787386b28b6"`)
        await db.query(`DROP INDEX "public"."IDX_9214b544b868819bae7a431c36"`)
        ...
        await db.query(`ALTER TABLE "ogn_address" DROP CONSTRAINT "FK_8ad97ec59533410a3467822242a"`)
        await db.query(`ALTER TABLE "ogn_lockup" DROP CONSTRAINT "FK_a38f7bb8e83ffb88f8c7be46760"`)
        await db.query(`ALTER TABLE "ogn_lockup_tx_log" DROP CONSTRAINT "FK_f5efab1b224515ed2df14e1ebfa"`)
        await db.query(`ALTER TABLE "ogn_proposal" DROP CONSTRAINT "FK_2d074f6338cb22a33155ab29bf2"`)
        await db.query(`ALTER TABLE "ogn_proposal_tx_log" DROP CONSTRAINT "FK_d28fb6515ffd9e89012dea5aa17"`)
        await db.query(`ALTER TABLE "ogn_proposal_vote" DROP CONSTRAINT "FK_a19f392300cd06e787386b28b69"`)
