module.exports = class Data1700163866113 {
    name = 'Data1700163866113'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "oeth_activity" ("id" character varying NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "tx_hash" text NOT NULL, "call_data_last4_bytes" text NOT NULL, "action" text, "exchange" text, "interface" text, "from_token_address" text, "to_token_address" text, "from_token_amount" numeric, "to_token_amount" numeric, "from" text, "to" text, CONSTRAINT "PK_8938e7a05e2377cb6dc46e6980c" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "ousd_activity" ("id" character varying NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "tx_hash" text NOT NULL, "call_data_last4_bytes" text NOT NULL, "action" text, "exchange" text, "interface" text, "from_token_address" text, "to_token_address" text, "from_token_amount" numeric, "to_token_amount" numeric, "from" text, "to" text, CONSTRAINT "PK_0f830a098aea9c70d8e8a626933" PRIMARY KEY ("id"))`)
