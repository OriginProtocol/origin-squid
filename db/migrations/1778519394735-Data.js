module.exports = class Data1778519394735 {
    name = 'Data1778519394735'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "o_token_address_yield" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "otoken" text NOT NULL, "address" text NOT NULL, "date" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "balance" numeric NOT NULL, "value" numeric NOT NULL, "cost_basis" numeric NOT NULL, "yield" numeric NOT NULL, "cumulative_yield" numeric NOT NULL, "roi" numeric NOT NULL, "last_credits_per_token" numeric NOT NULL, "yield_remainder" numeric NOT NULL, CONSTRAINT "PK_3a51ade95f29c46dce5ec03561b" PRIMARY KEY ("id"))`)
