 ...
 */
export class OToken_2025_07_01 {
  ...
  private async _autoMigrate(_account: string): Promise<void> {
    ...
    if (
      (await this.isContract(_account)) &&
  ...
  public async isContract(_account: string): Promise<boolean> {
    return await isContract(this.ctx, this.block, _account, true)
  }
