...
export const functions = {
    ...
    'add_liquidity(uint256[],uint256)': fun("0xb72df5de", "add_liquidity(uint256[],uint256)", {"_amounts": p.array(p.uint256), "_min_mint_amount": p.uint256}, p.uint256),
    'add_liquidity(uint256[],uint256,address)': fun("0xa7256d09", "add_liquidity(uint256[],uint256,address)", {"_amounts": p.array(p.uint256), "_min_mint_amount": p.uint256, "_receiver": p.address}, p.uint256),
    ...
    'remove_liquidity_imbalance(uint256[],uint256)': fun("0x7706db75", "remove_liquidity_imbalance(uint256[],uint256)", {"_amounts": p.array(p.uint256), "_max_burn_amount": p.uint256}, p.uint256),
    'remove_liquidity_imbalance(uint256[],uint256,address)': fun("0x4a6e32c6", "remove_liquidity_imbalance(uint256[],uint256,address)", {"_amounts": p.array(p.uint256), "_max_burn_amount": p.uint256, "_receiver": p.address}, p.uint256),
    'remove_liquidity(uint256,uint256[])': fun("0xd40ddb8c", "remove_liquidity(uint256,uint256[])", {"_burn_amount": p.uint256, "_min_amounts": p.array(p.uint256)}, p.array(p.uint256)),
    'remove_liquidity(uint256,uint256[],address)': fun("0x5e604cd2", "remove_liquidity(uint256,uint256[],address)", {"_burn_amount": p.uint256, "_min_amounts": p.array(p.uint256), "_receiver": p.address}, p.array(p.uint256)),
    'remove_liquidity(uint256,uint256[],address,bool)': fun("0x2969e04a", "remove_liquidity(uint256,uint256[],address,bool)", {"_burn_amount": p.uint256, "_min_amounts": p.array(p.uint256), "_receiver": p.address, "_claim_admin_fees": p.bool}, p.array(p.uint256)),
    ...
    calc_token_amount: viewFun("0x3db06dd8", "calc_token_amount(uint256[],bool)", {"_amounts": p.array(p.uint256), "_is_deposit": p.bool}, p.uint256),
...
export type Add_liquidityParams_0 = FunctionArguments<typeof functions['add_liquidity(uint256[],uint256)']>
export type Add_liquidityReturn_0 = FunctionReturn<typeof functions['add_liquidity(uint256[],uint256)']>

export type Add_liquidityParams_1 = FunctionArguments<typeof functions['add_liquidity(uint256[],uint256,address)']>
export type Add_liquidityReturn_1 = FunctionReturn<typeof functions['add_liquidity(uint256[],uint256,address)']>
...
export type Remove_liquidity_imbalanceParams_0 = FunctionArguments<typeof functions['remove_liquidity_imbalance(uint256[],uint256)']>
export type Remove_liquidity_imbalanceReturn_0 = FunctionReturn<typeof functions['remove_liquidity_imbalance(uint256[],uint256)']>

export type Remove_liquidity_imbalanceParams_1 = FunctionArguments<typeof functions['remove_liquidity_imbalance(uint256[],uint256,address)']>
export type Remove_liquidity_imbalanceReturn_1 = FunctionReturn<typeof functions['remove_liquidity_imbalance(uint256[],uint256,address)']>

export type Remove_liquidityParams_0 = FunctionArguments<typeof functions['remove_liquidity(uint256,uint256[])']>
export type Remove_liquidityReturn_0 = FunctionReturn<typeof functions['remove_liquidity(uint256,uint256[])']>

export type Remove_liquidityParams_1 = FunctionArguments<typeof functions['remove_liquidity(uint256,uint256[],address)']>
export type Remove_liquidityReturn_1 = FunctionReturn<typeof functions['remove_liquidity(uint256,uint256[],address)']>

export type Remove_liquidityParams_2 = FunctionArguments<typeof functions['remove_liquidity(uint256,uint256[],address,bool)']>
export type Remove_liquidityReturn_2 = FunctionReturn<typeof functions['remove_liquidity(uint256,uint256[],address,bool)']>
