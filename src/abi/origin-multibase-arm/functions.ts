import { address, array, bool, int256, string, struct, uint120, uint128, uint16, uint256, uint40, uint8 } from '@subsquid/evm-codec'
...
/** migrateLegacyWithdrawQueue() */
export const migrateLegacyWithdrawQueue = func('0x3c99ca9d', {})
export type MigrateLegacyWithdrawQueueParams = FunctionArguments<typeof migrateLegacyWithdrawQueue>
export type MigrateLegacyWithdrawQueueReturn = FunctionReturn<typeof migrateLegacyWithdrawQueue>
...
export const reservedWithdrawLiquidity = func('0xae6be1dd', {}, uint256)
