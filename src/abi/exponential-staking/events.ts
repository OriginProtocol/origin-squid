...
/** Penalty(address,uint256) */
export const Penalty = event('0x322e5021ddf51920f7602154a6c845b34ef1b32704a1fa2c66927b56be280762', {
    user: indexed(address),
    amount: uint256,
})
export type PenaltyEventArgs = EParams<typeof Penalty>
