...
export const events = {
    ...
    RewardCollected: event("0x9026b1dc1bd4688af8f4998f8cacc713a53fba753294da0efe4849a25c26023e", {"amountCollected": p.uint256}),
    RewardsPerSecondChanged: event("0xe261f91b5c3d9f16ed2268171bcd375f4aa1fe4b244cfe2e54a7d21be4735d46", {"newRPS": p.uint256, "oldRPS": p.uint256}),
    RewardsTargetChange: event("0x41ad0a33748dcbf4495041d0518e1204c1d5f0d65e7dccb51877235361e75f4a", {"target": p.address, "previousTarget": p.address}),
...
export const functions = {
    ...
    collectRewards: fun("0x70bb45b3", {}, p.uint256),
    governor: fun("0x0c340a24", {}, p.address),
    initialize: fun("0x485cc955", {"_strategistAddr": p.address, "_rewardsTarget": p.address}, ),
    isGovernor: fun("0xc7af3352", {}, p.bool),
    previewRewards: fun("0xe0d801dd", {}, p.uint256),
    rewardConfig: fun("0x4e94c285", {}, {"lastCollect": p.uint64, "rewardsPerSecond": p.uint192}),
    rewardToken: fun("0xf7c618c1", {}, p.address),
    rewardsTarget: fun("0x82487844", {}, p.address),
    setRewardsPerSecond: fun("0xdc9ec152", {"_rewardsPerSecond": p.uint192}, ),
    setRewardsTarget: fun("0x6411466f", {"_rewardsTarget": p.address}, ),
