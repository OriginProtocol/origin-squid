...
export const functions = {
    ...
    SNAP_BALANCES_DELAY: viewFun("0x9fb7247d", "SNAP_BALANCES_DELAY()", {}, p.uint64),
    ...
    registerSsvValidator: fun("0xdaa1e253", "registerSsvValidator(bytes,uint64[],bytes,(uint32,uint64,uint64,bool,uint256))", {"publicKey": p.bytes, "operatorIds": p.array(p.uint64), "sharesData": p.bytes, "cluster": p.struct({"validatorCount": p.uint32, "networkFeeIndex": p.uint64, "index": p.uint64, "active": p.bool, "balance": p.uint256})}, ),
...
export class Contract extends ContractBase {
    ...
    SNAP_BALANCES_DELAY() {
        return this.eth_call(functions.SNAP_BALANCES_DELAY, {})
    }
...
export type SNAP_BALANCES_DELAYParams = FunctionArguments<typeof functions.SNAP_BALANCES_DELAY>
export type SNAP_BALANCES_DELAYReturn = FunctionReturn<typeof functions.SNAP_BALANCES_DELAY>
