import { address, int256, uint256, uint64 } from '@subsquid/evm-codec'
...
/** ClaimBaseWithdrawals(address,uint256) */
export const ClaimBaseWithdrawals = event('0x8528f5537e4b9fc69da2fa4d455c4e03a5cc2c5a05d8815c8c06a6242f56ad57', {
    unstaker: indexed(address),
    liquidityAmount: uint256,
})
export type ClaimBaseWithdrawalsEventArgs = EParams<typeof ClaimBaseWithdrawals>
...
/** RequestBaseWithdrawal(address,uint256,uint256) */
export const RequestBaseWithdrawal = event('0x9910c447d600210d0328b2c6f5374d7acc58344b9ce5d9c97f5a2a90fa611956', {
    unstaker: indexed(address),
    baseAmount: uint256,
    liquidityAmount: uint256,
})
export type RequestBaseWithdrawalEventArgs = EParams<typeof RequestBaseWithdrawal>
