...
export const claimLidoWithdrawals = func('0x4e1d1840', {
    requestIds: array(uint256),
})
export type ClaimLidoWithdrawalsParams = FunctionArguments<typeof claimLidoWithdrawals>
export type ClaimLidoWithdrawalsReturn = FunctionReturn<typeof claimLidoWithdrawals>
...
/** lidoWithdrawalQueue() */
export const lidoWithdrawalQueue = func('0xff3368a1', {}, address)
export type LidoWithdrawalQueueParams = FunctionArguments<typeof lidoWithdrawalQueue>
export type LidoWithdrawalQueueReturn = FunctionReturn<typeof lidoWithdrawalQueue>

/** lidoWithdrawalQueueAmount() */
export const lidoWithdrawalQueueAmount = func('0x31ca1c02', {}, uint256)
export type LidoWithdrawalQueueAmountParams = FunctionArguments<typeof lidoWithdrawalQueueAmount>
export type LidoWithdrawalQueueAmountReturn = FunctionReturn<typeof lidoWithdrawalQueueAmount>
...
/** requestLidoWithdrawals(uint256[]) */
export const requestLidoWithdrawals = func('0x674eb980', {
    amounts: array(uint256),
}, array(uint256))
export type RequestLidoWithdrawalsParams = FunctionArguments<typeof requestLidoWithdrawals>
export type RequestLidoWithdrawalsReturn = FunctionReturn<typeof requestLidoWithdrawals>
...
/** steth() */
export const steth = func('0x953d7ee2', {}, address)
