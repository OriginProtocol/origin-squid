...
import { activeMarket, allocate, allocateThreshold, allowance, approve, armBuffer, asset, balanceOf, baseAssetConfigs, capManager, claimBaseAssetRedeem, claimDelay, claimRedeem, claimable, collectFees, convertToAssets, convertToShares, decimals, deposit, deposit_1, fee, feeCollector, feesAccrued, getBaseAssets, getReserves, liquidityAsset, liquidityAssetDecimals, minSharesToRedeem, name, nextWithdrawalIndex, operator, owner, paused, previewDeposit, previewRedeem, requestBaseAssetRedeem, requestRedeem, reservedWithdrawLiquidity, supportedMarkets, swapExactTokensForTokens, swapExactTokensForTokens_1, swapTokensForExactTokens, swapTokensForExactTokens_1, symbol, totalAssets, totalSupply, transfer, transferFrom, withdrawalRequestShares, withdrawalRequests, withdrawsClaimedShares, withdrawsQueuedShares } from './functions.js'
import type { AllowanceParams, ApproveParams, BalanceOfParams, BaseAssetConfigsParams, ClaimBaseAssetRedeemParams, ClaimRedeemParams, ConvertToAssetsParams, ConvertToSharesParams, DepositParams, DepositParams_1, GetReservesParams, PreviewDepositParams, PreviewRedeemParams, RequestBaseAssetRedeemParams, RequestRedeemParams, SupportedMarketsParams, SwapExactTokensForTokensParams, SwapExactTokensForTokensParams_1, SwapTokensForExactTokensParams, SwapTokensForExactTokensParams_1, TransferFromParams, TransferParams, WithdrawalRequestSharesParams, WithdrawalRequestsParams } from './functions.js'
...
export class Contract extends ContractBase {
    ...
    getBaseAssets() {
        return this.eth_call(getBaseAssets, {})
    }
    ...
    liquidityAssetDecimals() {
        return this.eth_call(liquidityAssetDecimals, {})
    }
    ...
    withdrawalRequestShares(requestId: WithdrawalRequestSharesParams["requestId"]) {
        return this.eth_call(withdrawalRequestShares, {requestId})
    }
