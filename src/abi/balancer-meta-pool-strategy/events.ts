...
/** MaxDepositDeviationUpdated(uint256,uint256) */
export const MaxDepositDeviationUpdated = event('0x42ef8699937e03e56ce59a64b430e1a18719693244c594c7884f9cb7c1c98e5c', {
    _prevMaxDeviationPercentage: uint256,
    _newMaxDeviationPercentage: uint256,
})
export type MaxDepositDeviationUpdatedEventArgs = EParams<typeof MaxDepositDeviationUpdated>

/** MaxWithdrawalDeviationUpdated(uint256,uint256) */
export const MaxWithdrawalDeviationUpdated = event('0xdea5bd7251b6797372e2785ac437c2b046149b71216727e0d33ab3140b11d6f7', {
    _prevMaxDeviationPercentage: uint256,
    _newMaxDeviationPercentage: uint256,
})
export type MaxWithdrawalDeviationUpdatedEventArgs = EParams<typeof MaxWithdrawalDeviationUpdated>
