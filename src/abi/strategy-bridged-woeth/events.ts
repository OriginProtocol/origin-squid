import { address, array, uint128, uint256 } from '@subsquid/evm-codec'
...
/** MaxPriceDiffBpsUpdated(uint128,uint128) */
export const MaxPriceDiffBpsUpdated = event('0x5066a7b9bf5907d8b921adeaade475273e40a7302cab0e838ef9fa2094b06b7f', {
    oldValue: uint128,
    newValue: uint128,
})
export type MaxPriceDiffBpsUpdatedEventArgs = EParams<typeof MaxPriceDiffBpsUpdated>
...
/** WOETHPriceUpdated(uint128,uint128) */
export const WOETHPriceUpdated = event('0x688768fc37ada60fd073f86fafc8d5aa7fe9d86750ddf224bc0366812c086fe8', {
    oldValue: uint128,
    newValue: uint128,
})
export type WOETHPriceUpdatedEventArgs = EParams<typeof WOETHPriceUpdated>
