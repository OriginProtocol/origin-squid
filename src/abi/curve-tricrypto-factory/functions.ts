...
export const deploy_pool = func('0xaa38b385', {
    _name: string,
    _symbol: string,
    _coins: fixedSizeArray(address, 3),
    _weth: address,
    ...
    ma_exp_time: uint256,
    initial_prices: fixedSizeArray(uint256, 2),
}, address)
