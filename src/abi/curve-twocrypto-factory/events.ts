...
/** TwocryptoPoolDeployed(address,string,string,address[2],address,bytes32,uint256[2],uint256,uint256,uint256,uint256,address) */
export const TwocryptoPoolDeployed = event('0x8152a3037e3dc54154ad0d2cadb1cf7e1d1b9e2b625faa3dfb4fe03d609102ca', {
    pool: address,
    name: string,
    symbol: string,
    coins: fixedSizeArray(address, 2),
    math: address,
    salt: bytes32,
    precisions: fixedSizeArray(uint256, 2),
...
export type TwocryptoPoolDeployedEventArgs = EParams<typeof TwocryptoPoolDeployed>
