...
export class Contract extends ContractBase {
    deploy_pool(_name: Deploy_poolParams["_name"], _symbol: Deploy_poolParams["_symbol"], _coins: Deploy_poolParams["_coins"], implementation_id: Deploy_poolParams["implementation_id"], A: Deploy_poolParams["A"], gamma: Deploy_poolParams["gamma"], mid_fee: Deploy_poolParams["mid_fee"], out_fee: Deploy_poolParams["out_fee"], fee_gamma: Deploy_poolParams["fee_gamma"], allowed_extra_profit: Deploy_poolParams["allowed_extra_profit"], adjustment_step: Deploy_poolParams["adjustment_step"], ma_exp_time: Deploy_poolParams["ma_exp_time"], initial_price: Deploy_poolParams["initial_price"]) {
        return this.eth_call(deploy_pool, {_name, _symbol, _coins, implementation_id, A, gamma, mid_fee, out_fee, fee_gamma, allowed_extra_profit, adjustment_step, ma_exp_time, initial_price})
    }
