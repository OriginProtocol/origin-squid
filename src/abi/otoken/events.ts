...
export const YieldDelegated = event('0x31e39e4bb9df9d4143551c8a3a4798fc19b0854768570ce84d966f6adffd01a3', {
    source: address,
    target: address,
})
export type YieldDelegatedEventArgs = EParams<typeof YieldDelegated>

/** YieldUndelegated(address,address) */
export const YieldUndelegated = event('0xa4fa89dd14422a509261a2d4d459f93abdc84c6e92c5e7ae5448243713967bd3', {
    source: address,
    target: address,
})
export type YieldUndelegatedEventArgs = EParams<typeof YieldUndelegated>
