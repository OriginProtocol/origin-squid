import { address, bool, bytes32, string, struct, uint128, uint224, uint256, uint32, uint8 } from '@subsquid/evm-codec'
...
export const extend = func('0xc89258db', {
    lockupId: uint256,
    duration: uint256,
})
export type ExtendParams = FunctionArguments<typeof extend>
export type ExtendReturn = FunctionReturn<typeof extend>
...
/** ogv() */
export const ogv = func('0x142561cf', {}, address)
export type OgvParams = FunctionArguments<typeof ogv>
export type OgvReturn = FunctionReturn<typeof ogv>
...
export const stake = func('0x7628a37d', {
    amount: uint256,
    duration: uint256,
    to: address,
})
...
export const stake_1 = func('0x7b0472f0', {
    amount: uint256,
    duration: uint256,
})
export type StakeParams_1 = FunctionArguments<typeof stake_1>
export type StakeReturn_1 = FunctionReturn<typeof stake_1>
