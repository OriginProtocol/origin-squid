import { address, array, bool, bytes32, fixedSizeArray, int128, string, uint256, uint8 } from '@subsquid/evm-codec'
...
export const exchange_underlying = func('0xa6417ed6', {
    i: int128,
    j: int128,
    _dx: uint256,
    _min_dy: uint256,
}, uint256)
export type Exchange_underlyingParams = FunctionArguments<typeof exchange_underlying>
export type Exchange_underlyingReturn = FunctionReturn<typeof exchange_underlying>

/** exchange_underlying(int128,int128,uint256,uint256,address) */
export const exchange_underlying_1 = func('0x44ee1986', {
    i: int128,
    j: int128,
    _dx: uint256,
    _min_dy: uint256,
...
export type Exchange_underlyingParams_1 = FunctionArguments<typeof exchange_underlying_1>
export type Exchange_underlyingReturn_1 = FunctionReturn<typeof exchange_underlying_1>
...
/** remove_liquidity(uint256,uint256[2],address,bool) */
export const remove_liquidity_2 = func('0xdb1bb01b', {
    _burn_amount: uint256,
    _min_amounts: fixedSizeArray(uint256, 2),
    _receiver: address,
...
export const get_dx_underlying = func('0x0e71d1b9', {
    i: int128,
    j: int128,
    dy: uint256,
}, uint256)
export type Get_dx_underlyingParams = FunctionArguments<typeof get_dx_underlying>
export type Get_dx_underlyingReturn = FunctionReturn<typeof get_dx_underlying>
...
export const get_dy_underlying = func('0x07211ef7', {
    i: int128,
    j: int128,
    dx: uint256,
}, uint256)
export type Get_dy_underlyingParams = FunctionArguments<typeof get_dy_underlying>
export type Get_dy_underlyingReturn = FunctionReturn<typeof get_dy_underlying>
...
/** BASE_POOL() */
export const BASE_POOL = func('0x71511a5e', {}, address)
export type BASE_POOLParams = FunctionArguments<typeof BASE_POOL>
export type BASE_POOLReturn = FunctionReturn<typeof BASE_POOL>

/** BASE_N_COINS() */
export const BASE_N_COINS = func('0x3da575a1', {}, uint256)
export type BASE_N_COINSParams = FunctionArguments<typeof BASE_N_COINS>
export type BASE_N_COINSReturn = FunctionReturn<typeof BASE_N_COINS>

/** BASE_COINS(uint256) */
export const BASE_COINS = func('0xd52d5b86', {
    arg0: uint256,
}, address)
export type BASE_COINSParams = FunctionArguments<typeof BASE_COINS>
export type BASE_COINSReturn = FunctionReturn<typeof BASE_COINS>
