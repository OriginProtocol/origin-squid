...
export const functions = {
    ...
    maxMint: fun("0xc63d75b6", {"owner": p.address}, p.uint256),
    ...
    processIdleRewards: fun("0x3e8b83e3", {}, ),
    ...
    "withdraw(uint256,bool)": fun("0x38d07436", {"amount": p.uint256, "claim": p.bool}, p.bool),
    "withdraw(uint256,address,address)": fun("0xb460af94", {"assets": p.uint256, "receiver": p.address, "owner": p.address}, p.uint256),
