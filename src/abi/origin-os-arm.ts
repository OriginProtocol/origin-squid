...
export const events = {
    ...
    ClaimOriginWithdrawals: event("0xfc7782d0ea7f5eb0351be7139942ba2c71155735d797fab90b6f2cdb99bce927", "ClaimOriginWithdrawals(uint256[],uint256)", {"requestIds": p.array(p.uint256), "amountClaimed": p.uint256}),
    ...
    RequestOriginWithdrawal: event("0xb3a9170802de02e4fcb5968e12fb0b19c1e9e83035699af404f3dffbcdb6ac68", "RequestOriginWithdrawal(uint256,uint256)", {"amount": p.uint256, "requestId": p.uint256}),
...
export const functions = {
    ...
    claimOriginWithdrawals: fun("0x01d5850f", "claimOriginWithdrawals(uint256[])", {"requestIds": p.array(p.uint256)}, p.uint256),
    ...
    requestOriginWithdrawal: fun("0xaa5928be", "requestOriginWithdrawal(uint256)", {"amount": p.uint256}, p.uint256),
    ...
    vaultWithdrawalAmount: viewFun("0x0fa28841", "vaultWithdrawalAmount()", {}, p.uint256),
...
export class Contract extends ContractBase {
    ...
    vaultWithdrawalAmount() {
        return this.eth_call(functions.vaultWithdrawalAmount, {})
    }
...
export type ClaimOriginWithdrawalsEventArgs = EParams<typeof events.ClaimOriginWithdrawals>
...
export type RequestOriginWithdrawalEventArgs = EParams<typeof events.RequestOriginWithdrawal>
...
export type ClaimOriginWithdrawalsParams = FunctionArguments<typeof functions.claimOriginWithdrawals>
export type ClaimOriginWithdrawalsReturn = FunctionReturn<typeof functions.claimOriginWithdrawals>
...
export type RequestOriginWithdrawalParams = FunctionArguments<typeof functions.requestOriginWithdrawal>
export type RequestOriginWithdrawalReturn = FunctionReturn<typeof functions.requestOriginWithdrawal>
...
export type VaultWithdrawalAmountParams = FunctionArguments<typeof functions.vaultWithdrawalAmount>
export type VaultWithdrawalAmountReturn = FunctionReturn<typeof functions.vaultWithdrawalAmount>
