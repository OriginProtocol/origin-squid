...
import { BEACON_PROOFS, SNAP_BALANCES_DELAY, assetToPToken, checkBalance, depositList, depositListLength, depositedWethAccountedFor, deposits, firstDeposit, getRewardTokenAddresses, governor, harvesterAddress, initialDepositAmountWei, isGovernor, lastVerifiedEthBalance, paused, platformAddress, rewardTokenAddresses, snappedBalance, supportsAsset, validator, validatorRegistrator, vaultAddress, verifiedValidators, verifiedValidatorsLength } from './functions.js'
...
export class Contract extends ContractBase {
    ...
    initialDepositAmountWei() {
        return this.eth_call(initialDepositAmountWei, {})
    }
