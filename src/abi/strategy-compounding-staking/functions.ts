...
export const initialDepositAmountWei = func('0x4d03f360', {}, uint256)
export type InitialDepositAmountWeiParams = FunctionArguments<typeof initialDepositAmountWei>
export type InitialDepositAmountWeiReturn = FunctionReturn<typeof initialDepositAmountWei>

/** initialize(address[],address[],address[],uint256) */
export const initialize = func('0x624de1e1', {
    _rewardTokenAddresses: array(address),
    _assets: array(address),
    _pTokens: array(address),
    _initialDepositAmountWei: uint256,
})
...
/** setInitialDepositAmount(uint256) */
export const setInitialDepositAmount = func('0x3d577e6d', {
    _initialDepositAmountWei: uint256,
})
export type SetInitialDepositAmountParams = FunctionArguments<typeof setInitialDepositAmount>
export type SetInitialDepositAmountReturn = FunctionReturn<typeof setInitialDepositAmount>
