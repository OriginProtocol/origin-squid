...
/** InitialDepositAmountChanged(uint256) */
export const InitialDepositAmountChanged = event('0x839451c16ac0f5ee7eca98dc526bc2d478f9640abf52014944178cc7daad6b96', {
    amountWei: uint256,
})
export type InitialDepositAmountChangedEventArgs = EParams<typeof InitialDepositAmountChanged>
