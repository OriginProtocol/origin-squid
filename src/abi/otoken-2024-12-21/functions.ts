...
export const initialize = func('0xf542033f', {
    _nameArg: string,
    _symbolArg: string,
...
/** isUpgraded(address) */
export const isUpgraded = func('0x95ef84b9', {
    _0: address,
}, uint256)
export type IsUpgradedParams = FunctionArguments<typeof isUpgraded>
export type IsUpgradedReturn = FunctionReturn<typeof isUpgraded>
