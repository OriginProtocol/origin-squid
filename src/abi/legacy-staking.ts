...
export const events = {
    ...
    'Staked(address indexed,uint256,uint256,uint256)': event("0xb4caaf29adda3eefee3ad552a8e85058589bf834c7466cae4ee58787f70589ed", "Staked(address,uint256,uint256,uint256)", {"user": indexed(p.address), "amount": p.uint256, "duration": p.uint256, "rate": p.uint256}),
    ...
    'Withdrawn(address indexed,uint256,uint256)': event("0x92ccf450a286a957af52509bc1c9939d1a6a481783e142e41e2499f0bb66ebc6", "Withdrawn(address,uint256,uint256)", {"user": indexed(p.address), "amount": p.uint256, "stakedAmount": p.uint256}),
    ...
    'Staked(address indexed,uint256)': event("0x9e71bc8eea02a63969f509818f2dafb9254532904319f9dbda79b67bd34a5f3d", "Staked(address,uint256)", {"user": indexed(p.address), "amount": p.uint256}),
    'Withdrawn(address indexed,uint256)': event("0x7084f5476618d8e60b11ef0d7d3f06914655adb8793e28ff7f018d4c76d505d5", "Withdrawn(address,uint256)", {"user": indexed(p.address), "amount": p.uint256}),
}
...
export type StakedEventArgs_0 = EParams<typeof events['Staked(address indexed,uint256,uint256,uint256)']>
export type StakesTransferedEventArgs = EParams<typeof events.StakesTransfered>
export type WithdrawnEventArgs_0 = EParams<typeof events['Withdrawn(address indexed,uint256,uint256)']>
export type UpgradedEventArgs = EParams<typeof events.Upgraded>
export type StakedEventArgs_1 = EParams<typeof events['Staked(address indexed,uint256)']>
export type WithdrawnEventArgs_1 = EParams<typeof events['Withdrawn(address indexed,uint256)']>
