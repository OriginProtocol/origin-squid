...
export const functions = {
    deploy_pool: fun("0xaa38b385", "deploy_pool(string,string,address[3],address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256[2])", {"_name": p.string, "_symbol": p.string, "_coins": p.fixedSizeArray(p.address, 3), "_weth": p.address, "implementation_id": p.uint256, "A": p.uint256, "gamma": p.uint256, "mid_fee": p.uint256, "out_fee": p.uint256, "fee_gamma": p.uint256, "allowed_extra_profit": p.uint256, "adjustment_step": p.uint256, "ma_exp_time": p.uint256, "initial_prices": p.fixedSizeArray(p.uint256, 2)}, p.address),
    ...
    get_coins: viewFun("0x9ac90d3d", "get_coins(address)", {"_pool": p.address}, p.fixedSizeArray(p.address, 3)),
    get_decimals: viewFun("0x52b51555", "get_decimals(address)", {"_pool": p.address}, p.fixedSizeArray(p.uint256, 3)),
    get_balances: viewFun("0x92e3cc2d", "get_balances(address)", {"_pool": p.address}, p.fixedSizeArray(p.uint256, 3)),
...
/// Event types
export type TricryptoPoolDeployedEventArgs = EParams<typeof events.TricryptoPoolDeployed>
