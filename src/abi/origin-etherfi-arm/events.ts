import { address, array, int256, uint256, uint64 } from '@subsquid/evm-codec'
...
/** Allocated(address,int256) */
export const Allocated = event('0x8de94c5178842de5720920c14d6abd0f8367785673e0f607f37b91bda0f7700c', {
    market: indexed(address),
    assets: int256,
})
...
export const ClaimEtherFiWithdrawals = event('0x8e1e54871d51b13099eefa0b83d65f5f62d21e09e16029bb5cb77bf651d7d9a5', {
    requestIds: array(uint256),
})
export type ClaimEtherFiWithdrawalsEventArgs = EParams<typeof ClaimEtherFiWithdrawals>
...
/** RegisterEtherFiWithdrawalRequests(uint256[],uint256) */
export const RegisterEtherFiWithdrawalRequests = event('0x5bcd3d54a041466fb9b7b96cc95157490816813f67990974e3f3b24b58a5996b', {
    requestIds: array(uint256),
    totalAmountRequested: uint256,
})
export type RegisterEtherFiWithdrawalRequestsEventArgs = EParams<typeof RegisterEtherFiWithdrawalRequests>

/** RequestEtherFiWithdrawal(uint256,uint256) */
export const RequestEtherFiWithdrawal = event('0x175bf92b330cf62d4fa2e358efef3366f13d7f24cc251f7c7a6943de8c6e7a17', {
    amount: uint256,
    requestId: uint256,
})
export type RequestEtherFiWithdrawalEventArgs = EParams<typeof RequestEtherFiWithdrawal>
